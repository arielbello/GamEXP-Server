...
class ParamsControllerTest < ActionController::TestCase
  ...
  test "should create param" do
    assert_difference('Param.count') do
      post :create, param: { configuration_id: @param.configuration_id, name: @param.name, value: @param.value }
    end
  ...
  test "should update param" do
    patch :update, id: @param, param: { configuration_id: @param.configuration_id, name: @param.name, value: @param.value }
    assert_redirected_to param_path(assigns(:param))
  end
